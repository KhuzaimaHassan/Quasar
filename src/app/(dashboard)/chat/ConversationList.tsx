...
export function ConversationList() {
  ...
  // Default model for NEW chats. When an existing conversation is active,
  // the dropdown reflects that conversation's stored model instead.
  ...
  // When the user navigates to a new conversation, sync newChatModel so that
